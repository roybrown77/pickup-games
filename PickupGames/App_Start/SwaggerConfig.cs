...
namespace PickupGames
{
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "CareTeamMember.Identity.Api.WebRole");
                    ...
                    //
                    c.GroupActionsBy(apiDesc => apiDesc.Route.RouteTemplate.ToString());
                    ...
                    c.OperationFilter<AddPerfectServeHeader>();
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //
                    //c.InjectJavaScript(thisAssembly, "CareTeamMember.Identity.Api.WebRole.swaggerInject.js");
    ...
    internal class AddFileUploadParams : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            if (operation.operationId == "RosterUploads_UploadRosterBySiteidAndSiteidAndSendinvitations")
            {
    ...
    internal class AddPerfectServeHeader : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            operation.parameters.Add(
